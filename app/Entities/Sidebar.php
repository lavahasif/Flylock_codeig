...
class Menu
{
    ...
    static function getMenu()
    {
        return array(
            ...
            new Menu('Locking Reason', '/', 'fa fa-question-circle', [
            ...
            new Menu('Logging/Logout Report', '/', 'fa fa-question-circle'),
            new Menu('User Registration', '/', 'fa fa-question-circle'),
            new Menu('DepartMent Registration', '/', 'fa fa-question-circle'),
